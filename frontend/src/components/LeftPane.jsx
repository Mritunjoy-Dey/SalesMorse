...
import { Upload, FileText, Mail, Phone, File as FileIcon, X, Sparkles } from "lucide-react";
...
export default function LeftPane({ files, onUpload, onDelete, onGenerate, generating, canGenerate }) {
      ...
      <div className="px-6 mt-4 flex-1 overflow-y-auto sm-scroll" data-testid="file-list">
        <div className="flex flex-col gap-2">
          {files.map((f) => (
            <div
              key={f.id}
              className="group flex items-center gap-3 rounded-xl bg-[#F0E9F5]/70 hover:bg-[#F0E9F5] px-3 py-2.5 transition-colors"
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="text-[10.5px] font-mono text-[rgba(61,58,74,0.5)] uppercase tracking-wider">
